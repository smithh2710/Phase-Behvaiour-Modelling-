...
[GOC_depth, GOC_pressure, GOC_comp, GOC_temp] = detect_sgoc(3, comp_ref, press_ref, temp_ref, h_ref, dTdh, [0 175], Pc, Tc, acentric, BIP, M_gmol, Cp_coeffs, H_ig_ref, vt_method, vt_params);
