function [stability, x_trial1, x_trial2, TPD_min, converged] = stability_analysis_ssi(comp, press, temp, Pc, Tc, acentric, BIP, tol, maxiter, eos_type,components )
...
[fugcoef_z, ~] = fugacitycoef_multicomp(comp, press, temp, Pc, Tc, acentric, BIP, eos_type,components);
...
for trial = 1:n_trials
    ...
    for iter = 1:maxiter
        ...
        try
            [fugcoef_X, ~] = fugacitycoef_multicomp(x, press, temp, Pc, Tc, acentric, BIP, eos_type,components);
        catch
