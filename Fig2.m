...
h_extra_oil = [3648; 3651.1; 3655; 3661.6; 3670; 3682.8];
...
for k = 1:n_cases
    ...
    h_legs(k) = plot(cases(k).oil_rho(v_oil), cases(k).h_oil(v_oil), ls, ...
...
for k = 1:n_cases
    ...
    h_legs(k) = plot(cases(k).oil_GOR(v_oil), cases(k).h_oil(v_oil), ls, ...
        'Color', col, 'LineWidth', lw);
