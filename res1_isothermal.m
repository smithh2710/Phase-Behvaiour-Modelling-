...
vt_method = 0;
 ...
 [GOC_depth, GOC_pressure, GOC_comp, GOC_temp] = detect_sgoc(1, comp_ref, press_ref, temp_ref, h_ref, dTdh, [0 175], Pc, Tc, acentric, BIP, M_gmol, Cp_coeffs, H_ig_ref, vt_method, vt_params);

 % [ comp_h, P_h, T_h, Pb, ~] = main_hasse(h_ref, h_ref, comp_ref, press_ref, temp_ref, dTdh, Pc, Tc, acentric, BIP, M_gmol, Cp_coeffs, H_ig_ref, vt_method, vt_params)
%% Oil zon
...
%% Gas zone
h_gas = [GOC_depth,(GOC_depth-30),40, 20, 0];
n_gas = length(h_gas);
